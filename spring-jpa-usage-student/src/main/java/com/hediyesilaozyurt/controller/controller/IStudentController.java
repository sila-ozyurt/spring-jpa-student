...
public interface IStudentController {
    ...
    public RootEntity<RestPageableResponse<DtoStudentResponse>> findAll(RestPageableRequest pageableRequest);
    ...
    public RootEntity<RestPageableResponse<DtoStudentResponse>> getStudentsByDepartment(Long id,RestPageableRequest pageableRequest);
    public RootEntity<RestPageableResponse<DtoStudentResponse>> findStudentByCourseId(Long courseId,RestPageableRequest pageableRequest);
    public RootEntity<Integer> getNumberOfTotalStudents();

    //search operations
    public RootEntity<DtoStudentResponse> findByUsername(String username);
    public RootEntity<RestPageableResponse<DtoStudentResponse>> searchByFirstName(String name,RestPageableRequest pageableRequest);
    public RootEntity<RestPageableResponse<DtoStudentResponse>> sortByBirthDate(RestPageableRequest pageableRequest);
